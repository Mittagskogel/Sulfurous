...
var P = (function () {
  ...
  IO.PROJECT_URL = './project/';
  IO.ASSET_URL = './project/asset/';
  ...
  IO.loadScratchr2Project = function (id, callback, self) {
    ...
    request.defer = true;
    var url = IO.PROJECT_URL + id + '/project.json';
  ...
  IO.loadScratchr2ProjectTitle = function (id, callback, self) {
    ...
    request.defer = true;
    request.add(P.IO.load('./project/' + id + '/').onLoad(function (data) {
  ...
  IO.loadSB2Project = function (ab, callback, self) {
    ...
    try {
      ...
      if (callback) request.onLoad(callback.bind(self));
      if (request.isDone) {
        console.log("workinggggg1")
        request.load(new Stage().fromJSON(json));
      } else {
        request.defer = false;
        request.getResult = function () {
          console.log("workinggggg2")
          return new Stage().fromJSON(json);
        };
      }
    } catch (e) {
...
var socket = io.connect("https://sulfurous.aau.at" + ':8082');
